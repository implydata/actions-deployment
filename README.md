...
`implydata/actions-deployment` is a [GitHub Action](https://github.com/features/actions) for working painlessly with [GitHub deployment statuses](https://docs.github.com/en/rest/reference/deployments).
  ...
  deploy:
    ...
    steps:
      - name: start deployment
        uses: implydata/actions-deployment@main
        id: deployment
        with:
          step: start
...
| `auto_deactivate` | `false` | Whether to mark existing deployments of this environment as inactive                                |
...
| `auto_deactivate` | `true`  | Whether to manually mark existing deployments of this environment as inactive     |
...
The argument `debug: true` can be provided to print arguments used by `actions-deployment` and log debug information.

If you run into an problems or have any questions, feel free to open an [issue](https://github.com/implydata/actions-deployment/issues)!
